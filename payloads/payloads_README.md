...
| `b3-lote-itens.json` | B3 — Splitter (lote com 3 itens) |
| `b4-lote-8itens.json` | B4 — Aggregator (lote com 8 itens) |
| `b5-ordem-producao.json` | B5 — Multicast (Ordem de Produção) |

## 🇨 Bloco C — Resiliência e Erros
| Arquivo | Cenário |
|---|---|
| `c1-ordem-valida.json` | C1 — Exception Subprocess (ordem válida → 200) |
| `c1-ordem-invalida.json` | C1 — Exception Subprocess (ordem inválida → 422) |
| `c2-confirmacao-producao.json` | C2 — Retry (confirmação de produção) |
